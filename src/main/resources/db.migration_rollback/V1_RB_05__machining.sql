...
DROP INDEX IF EXISTS idx_processed_item_id_pimb;
DROP INDEX IF EXISTS idx_available_inspection_pimb;
DROP INDEX IF EXISTS idx_available_machining_pimb;
DROP INDEX IF EXISTS idx_reject_pieces_pimb;
DROP INDEX IF EXISTS idx_rework_pieces_pimb;
