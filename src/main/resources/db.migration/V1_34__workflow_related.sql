...
CREATE TABLE IF NOT EXISTS workflow_step (
    ...
    CONSTRAINT unique_step_order_template UNIQUE (workflow_template_id, step_order, deleted)
    );
...
-- Create performance indexes for workflow_step
CREATE INDEX IF NOT EXISTS idx_workflow_step_template_order ON workflow_step(workflow_template_id, step_order, deleted);
...
COMMENT ON TABLE workflow_step IS 'Individual steps within a workflow template, defining operations and their order';
