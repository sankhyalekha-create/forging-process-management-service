...
public class MachineResource {
  ...
  public ResponseEntity<?> createMachine(@RequestBody MachineRepresentation machineRepresentation) {
    try {
      if (isInvalidMachineRepresentation(machineRepresentation)) {
  ...
  @GetMapping("machines")
  public ResponseEntity<?> getAllMachinesOfTenant(
  ...
  public ResponseEntity<MachineListRepresentation> getAllMachinesAvailableForMachineSetOfTenant() {
    Long tId = TenantContextHolder.getAuthenticatedTenantId();
  ...
  public ResponseEntity<MachineRepresentation> updateMachine(
    ...
    if (machineId == null || machineId.isEmpty() || isInvalidMachineRepresentation(machineRepresentation)) {
  ...
  @GetMapping(value = "searchMachines", produces = MediaType.APPLICATION_JSON)
