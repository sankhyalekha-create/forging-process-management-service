...
public class MachineSetResource {
  ...
  @PostMapping("machineSet")
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.APPLICATION_JSON)
  public ResponseEntity<?> createMachineSet(@RequestBody MachineSetRepresentation machineSetRepresentation) {
    try {
      if (isInvalidMachineSetRepresentation(machineSetRepresentation)) {
  ...
  @GetMapping("machineSets")
  public ResponseEntity<?> getAllMachineSetsOfTenant(
  ...
  @GetMapping("available-machine-sets-for-provided-time-period")
  ...
  @PostMapping("machineSet/{machineSetId}")
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.APPLICATION_JSON)
  public ResponseEntity<?> updateMachineSet(
    ...
    try {
      if ( machineSetId == null || machineSetId.isEmpty() || isInvalidMachineSetRepresentation(machineSetRepresentation)) {
  ...
  @DeleteMapping("machineSet/{machineSetId}")
  @Produces(MediaType.APPLICATION_JSON)
  ...
  @GetMapping(value = "searchMachineSets", produces = MediaType.APPLICATION_JSON)
