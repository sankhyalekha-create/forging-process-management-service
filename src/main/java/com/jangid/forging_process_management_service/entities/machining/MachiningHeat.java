...
@Table(name = "machining_heat")
public class MachiningHeat {

  @Id
  @GeneratedValue(strategy = GenerationType.AUTO, generator = "machining_heat_key_sequence_generator")
  @SequenceGenerator(name = "machining_heat_key_sequence_generator", sequenceName = "machining_heat_sequence", allocationSize = 1)
  private Long id;
