...
public class InvoiceRepresentation {
    ...
    @JsonProperty("supplierAddress1")
    private String supplierAddress1;
    
    @JsonProperty("supplierAddress2")
    ...
    @JsonProperty("recipientAddress1")
    ...
    // E-Invoice Fields (for GST e-invoice compliance)
    /**
     * Invoice Reference Number (IRN) - Generated by GST portal
     */
    @JsonProperty("irn")
    private String irn;

    /**
     * Acknowledgement Number from GST e-invoice portal
     */
    @JsonProperty("ackNo")
    private String ackNo;

    /**
     * Acknowledgement Date from GST e-invoice portal
     */
  ...
  @JsonProperty("eway_bill_threshold")
  private BigDecimal ewayBillThreshold;

    // E-Way Bill Fields
    /**
     * E-Way Bill Number (12 digits) - Generated by GSP API
     */
    ...
    /**
     * E-Way Bill alert/expiry notification flag
     */
    ...
    /**
     * E-Way Bill Sub Supply Type: 1=Supply, 2=Import, 3=Export, etc.
     */
    @JsonProperty("ewayBillSubSupplyType")
    private Integer ewayBillSubSupplyType;

    /**
     * E-Way Bill Document Type: INV, BIL, BOE, CHL, OTH
     */
    @JsonProperty("ewayBillDocType")
    private String ewayBillDocType;

    /**
     * E-Way Bill Transaction Type: 1=Regular, 2=Bill To-Ship To, etc.
     */
    ...
    /**
     * Count of payments associated with this invoice.
     * Used for displaying payment history count without fetching all payment details.
     */
